...
if __name__ == '__main__':
    ...
    df = df.set_index(['patientID'], drop = False)
    print(df.shape)
    df.to_hdf('c:\\Research_data\\Analysis\\pandas_lab_dump_4_26_16.h5', key = 'lab_collection', format = 'table',
              append = False)

    ddf = dd.from_pandas(df, npartitions = 1000)
    ddf.to_hdf('c:\\Research_data\\Analysis\\dask_lab_dump_4_26_16.h5', key = 'lab_collection')
